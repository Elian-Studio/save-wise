...
- **가이드 기사 3편 추가 (웹진 총 8편)** — 「국민취업지원제도 조건 총정리 — 1유형·2유형 차이」,
  「K-패스 vs 경기패스, 35세 이후엔 뭐가 달라질까」, 「청년지원금은 왜 신청기간이 제일 중요할까 — 2026 일정 모음」.
  일정·요건은 확정 값만 표기, 미발표 일정은 공고 확인 안내.

## [1.7.0] — 2026-07-19

### Added

- **은행 상세 심층 가이드 (7개 은행)** — KB국민·우리·하나·신한·NH농협·IBK기업·카카오뱅크 페이지에 은행별
  우대조건 해설, "맞는 사람 / 안 맞는 사람" 판정, 주의점, FAQ 추가. 각 은행의 공시 조건에서만 파생한 고유 분석
  (예: 하나 = 도약계좌 보유자도 첫거래 우대 충족 → 갈아타기 최적, 카카오 = 급여 우대 없음 → 프리랜서 적합).
- **가이드 기사 「은행별 우대금리, 뭘 봐야 하나」** — 우대금리 3축(급여·카드·갈아타기) 읽는 법과 14개 은행
  전체 링크 표. 웹진 총 5편.

### Fixed

- **다크모드 연녹색 패널 가독성** — 은행 상세의 '도약계좌 보유자라면'·'맞는 사람' 카드 텍스트가 다크모드에서
  보이지 않던 문제 수정.
