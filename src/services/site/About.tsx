...
export function About() {
  return (
    <article className="mx-auto max-w-[720px] px-[18px] py-10 leading-[1.75] text-foreground">
      ...
      <p className="mt-5">
        choicewise는 정부 지원 제도를 내 상황에 맞게 비교해 주는 무료 계산·비교 도구입니다. 교통카드 추천(패스와이즈),
        청년적금 계산기, 청년 지원금 추천을 제공하며, 회원가입이나 개인정보 수집 없이 브라우저 안에서만 계산이
        이루어집니다.
      </p>

      <h2 className="mt-9 text-lg font-bold text-ink">무엇을 하는 서비스인가요</h2>
      <p className="mt-3">
        패스와이즈는 K-패스·The 경기패스·인천 I-패스·후불 교통카드 등 여러 제도를 30초 퀴즈로 비교해,
        거주지·나이·이용 패턴에 맞는 교통카드를 추천합니다. 청년적금 계산기는 청년도약계좌 유지와 청년미래적금
        갈아타기(또는 신규 가입)를 내 소득·거래은행 기준으로 비교하고 가장 유리한 은행까지 찾아줍니다. 청년 지원금
        추천은 청년내일저축계좌·청년월세 특별지원·청년 주택드림 청약통장 등 여러 제도를 나이·소득·주거 상황 기준으로
        확인해 지금 신청할 수 있는 지원금을 찾아줍니다. 모든 기능은 무료이며 광고 외에는 별도 비용이 없습니다.
      </p>

      <h2 className="mt-9 text-lg font-bold text-ink">왜 만들었나요</h2>
      <p className="mt-3">
        K-패스·경기패스, 청년 적금 같은 정부 지원 제도는 조건이 복잡해서 어떤 선택지가 나에게 맞는지 알기
      ...
      <p className="mt-3">
        ...
        금융위원회 보도자료, 서민금융진흥원 안내를, 청년 지원금은 각 제도 주관기관(보건복지부·고용노동부·국토교통부
        등)의 공고와 복지로·정부24 안내를 근거로 합니다. 아직 공식적으로 확인되지 않았거나 추정에 해당하는
        값은 화면에서 그렇게 표기합니다.
      </p>
