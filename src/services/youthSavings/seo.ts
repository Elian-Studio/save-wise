...
export const youthSavingsSeo: RouteSeo = {
  ...
  description:
    '청년도약계좌 유지 vs 청년미래적금 갈아타기, 내 소득·거래은행으로 비교하고 가장 유리한 은행까지 찾는 무료 계산기.',
  keywords:
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '네. 청년미래적금은 단독 신규 가입이 가능합니다. 도약계좌 보유자가 받는 ‘도약 연계’ 우대는, 신규 가입자도 대부분 은행에서 ‘첫거래(예적금 미보유)’ 조건으로 동일하게 받을 수 있습니다(해당 은행 직전 6개월~1년 예적금이 없는 첫거래 기준 — 기존 예적금이 있으면 빠질 수 있음).',
          },
        },
        {
          '@type': 'Question',
