...
export const youthBenefitsSeo: RouteSeo = {
  path: '/youth-benefits',
  title: '청년 지원금 자격진단 — 내가 받을 수 있는 지원금 (2026)',
  description:
    '청년내일저축계좌·국민취업지원제도·주택드림 청약통장·청년월세 등 2026년 청년 지원금을 나이·가구소득·주거로 30초 만에 진단해 받을 수 있는 지원금을 찾아주는 무료 자격진단.',
  keywords:
    '청년 지원금, 청년 지원금 자격, 청년내일저축계좌, 국민취업지원제도, 청년 주택드림 청약통장, 청년월세 특별지원, 청년 정부지원금, 청년 자격진단',
