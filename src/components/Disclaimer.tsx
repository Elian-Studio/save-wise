  ...
  return (
    <>
      <div className="mt-4 rounded-[10px] border bg-card px-4 py-3.5 text-xs text-muted-foreground">
        ...
        우대금리는 갈아타기 자동충족(도약 연계가입·예적금 미보유)·출시 우대에 급여이체·카드 우대와 공통우대(소득
        0.5%p·재무상담 0.2%p)를 합산하되 <b>기관 상한(3%p/2%p)으로 캡</b>합니다(최고 8%/7%). 항목별 %p·충족조건은{' '}
        <b>은행연합회 소비자포털 비교공시 정본(2026-06)</b> 기준이며, 일부 항목(횟수·금액)은 은행별로 달라 가입 전 재확인이
        필요합니다.
      </div>
