  ...
  body: {
    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          '갈아타기로 결론이 났다면, 순서가 생명입니다. ① 먼저 청미적에 가입·계좌개설을 하고, ② 그다음 청도계를 “특별중도해지”해야 합니다. 이 순서를 지켜야 청도계 기존 납입분의 정부기여금과 비과세가 손실 없이 환급금에 보존됩니다. 순서를 어겨 청도계를 먼저 해지하면 일반 중도해지가 되어 기여금과 비과세가 모두 사라집니다(절차 근거: [금융위원회 갈아타기 안내](https://www.fsc.go.kr/no010101/87106)).',
    ...
    faq: [
      ...
      {
        q: '지금도 청미적에 새로 가입할 수 있나요?',
        a: '1차 신규 접수는 2026-07-03에 마감됐고, 다음 접수는 2026년 12월로 예정돼 있습니다. 접수는 연 2회입니다. 기가입자라면 계산기로 유지·갈아타기 비교는 계속 이용할 수 있습니다.',
      },
    ],
    related: [
