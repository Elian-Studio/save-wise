...
export const BENEFITS: BenefitCard[] = [
  ...
  },
  {
    ...
    name: '청년월세 특별지원(2차)',
    category: '주거',
    summary: '부모와 따로 사는 무주택 청년에게 월세를 월 최대 20만원씩 최대 24개월(생애 1회) 지원해주는 제도야.',
    amountLabel: '월 최대 20만원 × 최대 24개월 (생애 1회)',
    annual: 2400000,
    caveat: '2026년 신규 신청(3.30~5.29)은 마감됐어요. 추가 모집 여부는 마이홈포털에서 확인하세요.',
    cta: { kind: 'apply', url: 'https://www.myhome.go.kr' },
    source: '복지로 공지(2026 신청 안내) bokjiro.go.kr 1309500, 정부24 161300000099',
  },
];
