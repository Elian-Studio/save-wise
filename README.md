...
| 서비스 | 경로 | 설명 |
|---|---|---|
| **교통카드 추천** | `/` | 2026 K-패스 모두의카드 실부담 vs 기후동행카드 비교 + 카드사 추가혜택 TOP5 추천(신청 링크 포함) |
| **청년적금 갈아타기** | `/youth-savings` | 청년도약계좌 유지 vs 청년미래적금 전환을 내 소득·거래은행 기준으로 비교, 최적 은행 추천 |
| **청년 지원금** | `/youth-benefits` | 국민취업지원제도·청년월세지원 등 청년 지원 제도 요건 확인 |
| **가이드 웹진** | `/guide` | 청년 돈 문제를 계산기와 함께 짚는 장문 가이드 (청도계 vs 청미적, 모두의카드 등) |
